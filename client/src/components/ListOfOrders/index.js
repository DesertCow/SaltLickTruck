  ...
  function newOrderRow(item, index) {
    ...
    switch (orderArray[3]) {
      case "Submitted":
        // code block
        initalColor = "#31a531"
        console.log("########## Submitted = " + orderArray[3] + " | Color = " + initalColor)
        // c[index].style.backgroundColor = blockColor;
    ...
    const updateOrderStatus = async (index, event, status, orderNumber) => {
      ...
      var c = document.getElementById("listOfOrdersID").childNodes;
    ...
    orderList.push(
      <li key={item} className="orderRow p-3 mx-2 mb-4" style={{ backgroundColor: initalColor }}>
        {/* // <li key={item} className="orderRow p-3 mx-2 mb-4" style={{ backgroundColor: orderColor }}> */}
        {/* // <li key={item} className="orderRow p-3 mx-2 mb-4" style={{ backgroundColor: this.target.style.backgroundColor }}> */}
